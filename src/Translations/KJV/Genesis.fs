...
let gen1 =
    div [] [
        p [ Class "" ] [
            ...
            str "And the earth was without form, and void; and darkness was upon the face of the deep. And the Spirit of God moved upon the face of the waters. "
            br []
            ...
            str "And God saw the light, that it was good: and God divided the light from the darkness. "
            br []
            span [ Class "content is-small has-text-grey-light"] [ str "5" ]
            str "And God called the light Day, and the darkness he called Night. And the evening and the morning were the first day. "
        ]
        p [ Class "" ] [
            span [ Class "content is-small has-text-grey-light"] [ str "6" ]
            str "And God said, Let there be a firmament in the midst of the waters, and let it divide the waters from the waters. "
            br []
            span [ Class "content is-small has-text-grey-light"] [ str "7" ]
            str "And God made the firmament, and divided the waters which were under the firmament from the waters which were above the firmament: and it was so. "
            br []
            span [ Class "content is-small has-text-grey-light"] [ str "8" ]
            str "And God called the firmament Heaven. And the evening and the morning were the second day. "
        ]
        p [ Class "" ] [
            span [ Class "content is-small has-text-grey-light"] [ str "9" ]
            str "And God said, Let the waters under the heaven be gathered together unto one place, and let the dry land appear: and it was so. "
            br []
            span [ Class "content is-small has-text-grey-light"] [ str "10" ]
            str "And God called the dry land Earth; and the gathering together of the waters called he Seas: and God saw that it was good. "
            br []
            span [ Class "content is-small has-text-grey-light"] [ str "11" ]
            str "And God said, Let the earth bring forth grass, the herb yielding seed, and the fruit tree yielding fruit after his kind, whose seed is in itself, upon the earth: and it was so. "
            br []
            span [ Class "content is-small has-text-grey-light"] [ str "12" ]
            str "And the earth brought forth grass, and herb yielding seed after his kind, and the tree yielding fruit, whose seed was in itself, after his kind: and God saw that it was good. "
            br []
            span [ Class "content is-small has-text-grey-light"] [ str "13" ]
            str "And the evening and the morning were the third day. "
        ]
        p [ Class "" ] [
            span [ Class "content is-small has-text-grey-light"] [ str "14" ]
            str "And God said, Let there be lights in the firmament of the heaven to divide the day from the night; and let them be for signs, and for seasons, and for days, and years: "
            br []
            span [ Class "content is-small has-text-grey-light"] [ str "15" ]
            str "And let them be for lights in the firmament of the heaven to give light upon the earth: and it was so. "
            br []
            span [ Class "content is-small has-text-grey-light"] [ str "16" ]
            str "And God made two great lights; the greater light to rule the day, and the lesser light to rule the night: he made the stars also. "
            br []
            span [ Class "content is-small has-text-grey-light"] [ str "17" ]
            str "And God set them in the firmament of the heaven to give light upon the earth, "
            br []
            span [ Class "content is-small has-text-grey-light"] [ str "18" ]
            str "And to rule over the day and over the night, and to divide the light from the darkness: and God saw that it was good. "
            br []
            span [ Class "content is-small has-text-grey-light"] [ str "19" ]
            str "And the evening and the morning were the fourth day. "
            br []
            span [ Class "content is-small has-text-grey-light"] [ str "20" ]
            str "And God said, Let the waters bring forth abundantly the moving creature that hath life, and fowl that may fly above the earth in the open firmament of heaven. "
            br []
            span [ Class "content is-small has-text-grey-light"] [ str "21" ]
            str "And God created great whales, and every living creature that moveth, which the waters brought forth abundantly, after their kind, and every winged fowl after his kind: and God saw that it was good. "
            br []
            span [ Class "content is-small has-text-grey-light"] [ str "22" ]
            str "And God blessed them, saying, Be fruitful, and multiply, and fill the waters in the seas, and let fowl multiply in the earth. "
            br []
            span [ Class "content is-small has-text-grey-light"] [ str "23" ]
            str "And the evening and the morning were the fifth day. "
        ]
        p [ Class "" ] [
            span [ Class "content is-small has-text-grey-light"] [ str "24" ]
            str "And God said, Let the earth bring forth the living creature after his kind, cattle, and creeping thing, and beast of the earth after his kind: and it was so. "
            br []
            span [ Class "content is-small has-text-grey-light"] [ str "25" ]
            str "And God made the beast of the earth after his kind, and cattle after their kind, and every thing that creepeth upon the earth after his kind: and God saw that it was good. "
        ]
        p [ Class "" ] [
            span [ Class "content is-small has-text-grey-light"] [ str "26" ]
            str "And God said, Let us make man in our image, after our likeness: and let them have dominion over the fish of the sea, and over the fowl of the air, and over the cattle, and over all the earth, and over every creeping thing that creepeth upon the earth. "
            br []
            span [ Class "content is-small has-text-grey-light"] [ str "27" ]
            str "So God created man in his own image, in the image of God created he him; male and female created he them. "
            br []
            span [ Class "content is-small has-text-grey-light"] [ str "28" ]
            str "And God blessed them, and God said unto them, Be fruitful, and multiply, and replenish the earth, and subdue it: and have dominion over the fish of the sea, and over the fowl of the air, and over every living thing that moveth upon the earth. "
        ]
        p [ Class "" ] [
            span [ Class "content is-small has-text-grey-light"] [ str "29" ]
            str "And God said, Behold, I have given you every herb bearing seed, which is upon the face of all the earth, and every tree, in the which is the fruit of a tree yielding seed; to you it shall be for meat. "
            br []
            span [ Class "content is-small has-text-grey-light"] [ str "30" ]
            str "And to every beast of the earth, and to every fowl of the air, and to every thing that creepeth upon the earth, wherein there is life, I have given every green herb for meat: and it was so. "
            br []
            span [ Class "content is-small has-text-grey-light"] [ str "31" ]
            str "And God saw every thing that he had made, and, behold, it was very good. And the evening and the morning were the sixth day."
        ]
    ]
